  ...
  return (
    <div className="Projects">
      ...
      <div className="project farmDiv">
        ...
        <div className="project tareDiv">
          
          <div className="projectContent">
          <div className="projectNameAndDesc"><p className="projectName">Tare Ticketing</p>
        ...
        <a href="https://github.com/Rshokar/Tare-Ticketing" className="projectLink">Go paperless!</a></div>
        
      </div>

      <div className="project sootDiv">
            <div className="projectContent">
